...
1.username system
2.storing move log, win/loss, color of piece for every user game


eg. username: Ayush
eg. game1: Ayush vs Hartej
will store game's move log in Ayush's and Hartej's Account
will store color of piece
will store win or loss

game_data = (move_log,(player1,player2),(who moved first,color of their piece), who won)
eg. game_data = (move_log,(Ayush,Hartej),(Ayush,yellow),Ayush)

will be able to show win loss ratio
ratio of win with yellow and red piece
will be able to view (3-5)past games
'''
